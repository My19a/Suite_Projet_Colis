...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 24px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div class="formulaire">
                <form method="post" action="/postal-univ/reception" enctype="multipart/form-data" id="colisForm" onsubmit="return confirm('Confirmer la réception à l\'université de ce colis ?\nUn e-mail de notification sera envoyé au demandeur.');">
                    ...
                    <div class="champ">
                        ...
                        <input type="text" id="numero_suivi" name="numero_suivi" class="saisie" placeholder="Ex: LP123456789FR">
                    </div>
        ...
        <div class="bloc" id="section-destinataire">
            <div class="formulaire">
                <h2 class="bloc-titre" style="margin-bottom: 12px;">Destinataire identifié</h2>

                <div class="champ" style="margin-bottom: 12px;">
                    <label class="etiquette">Nom du destinataire</label>
                    <div style="display: flex; gap: 8px;">
                        <input type="text" id="nom-manuel" class="saisie" placeholder="Ex: Valerie Touzet" style="flex: 1;">
