...
<div class="page-header">
    <div class="page-header-info">
        <h1 class="page-title">Commandes à recevoir</h1>
        <p class="page-subtitle">Bons de commande envoyés par l'éditeur avec colis attendus</p>
    </div>
</div>
