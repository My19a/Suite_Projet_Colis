            ...
            <form method="POST">
                <div class="champ">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="uid" name="uid" placeholder="placeholder="placeholder=""ex: jdupont"" required autocomplete="off" autofocus>
                    </div>
                </div>
                    ...
                    <div class="role-grid">
                        ...
                        <div class="role-option">
                            ...
                            <label for="role-departement">
                                ...
                                <span class="role-name">Département</span>
                            </label>
                        </div>
                    </div>
                </div>
